      ...
      <main className="relative pt-44 pb-44 px-6 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl w-full space-y-32">
          ...
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            ...
            <div className="shrink-0 flex flex-col items-start md:items-end gap-2 text-neutral-300 font-mono text-[10px] uppercase tracking-widest">
              <div>Session ID: <span className="text-neutral-300">{token.slice(0, 12)}...</span></div>
              <div>Generated: <span className="text-neutral-300">{new Date().toLocaleDateString('de-CH')}</span></div>
            </div>
          </header>

          {/* Radar & Summary Grid */}
          <div className="grid lg:grid-cols-2 gap-12">
            <FadeOnScroll className="rounded-[2.5rem] border border-white/10 bg-[#111111]/40 backdrop-blur-xl p-8 md:p-12 transition-all hover:border-amber-500/10 group overflow-hidden relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 blur-[60px] rounded-full"></div>
              
              <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-300 mb-12 flex items-center gap-3">
                <span className="h-px w-4 bg-neutral-500"></span> System-Profil
              </h2>
            ...
            <div className="space-y-6">
              <FadeOnScroll className="rounded-[2.5rem] border border-white/10 bg-[#111111]/40 backdrop-blur-xl p-12 space-y-8 h-full">
                <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-300 flex items-center gap-3">
                  <span className="h-px w-4 bg-neutral-500"></span> Analytische Matrix
                </h2>
                  ...
                  {(insights?.axis_scores ?? axisScoresArr).map((a: any) => (
                    <div key={a.label} className="space-y-3 group">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-neutral-300 uppercase tracking-widest group-hover:text-neutral-100 transition-colors">{a.label}</span>
            ...
            <FadeOnScroll className="space-y-8">
              ...
              <div className="grid gap-6">
                {(insights?.strengths ?? []).map((s: any, i: number) => (
                  <div key={i} className="p-8 rounded-[2rem] border border-white/10 bg-[#111111]/30 hover:bg-[#111111]/50 transition-all group">
                    ...
                    <div className="text-sm text-neutral-300 font-light leading-relaxed">
          ...
          <FadeOnScroll className="space-y-16 pt-16 border-t border-white/10">
            <div className="max-w-4xl space-y-8">
              ...
              <h2 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.1]">Die systemische <span className="italic text-neutral-300">Architektur</span> im Blick.</h2>
            </div>

            <div className="grid gap-16 lg:grid-cols-2">
              <div className="space-y-12">
                <div className="space-y-6">
                  <h3 className="text-sm font-black uppercase tracking-[0.3em] text-neutral-300 flex items-center gap-4">
                    <span className="h-px w-6 bg-neutral-500"></span> Gesamt-Dynamik
                  </h3>
              ...
              <div className="space-y-12">
                <div className="space-y-6">
                  <h3 className="text-sm font-black uppercase tracking-[0.3em] text-neutral-300 flex items-center gap-4">
                    <span className="h-px w-6 bg-neutral-500"></span> Widersprüche
                  </h3>
                  <div className="prose prose-invert prose-amber max-w-none text-neutral-300 font-light leading-relaxed prose-p:mb-6">
                    <ReactMarkdown>{ai?.tensions_md ?? ""}</ReactMarkdown>
                  </div>
                </div>

                <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-amber-500/[0.05] to-transparent border border-amber-500/20 space-y-8">
                  <h3 className="text-sm font-black uppercase tracking-[0.3em] text-amber-500">Reflexionsfragen für Führung</h3>
                  <div className="prose prose-invert prose-sm prose-amber max-w-none text-neutral-300 font-light leading-relaxed prose-headings:text-neutral-100 prose-strong:text-amber-500 prose-p:mb-4">
          ...
          <FadeOnScroll className="pt-32 flex flex-col items-center text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <button 
                ...
                className="px-12 py-5 rounded-full border border-white/10 text-[11px] uppercase tracking-[0.2em] font-black hover:bg-white/10 transition-all"
              >
                PDF Speichern
              </button>
              <a 
                href="/#contact"
                className="px-12 py-5 rounded-full bg-neutral-50 text-neutral-950 text-[11px] uppercase tracking-[0.2em] font-black hover:bg-amber-400 transition-all shadow-xl shadow-white/10"
              >
